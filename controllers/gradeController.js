...
const create = async (req, res) => {
  try {
    const grade = await gradesModel(req.body);
    await grade.save();
...
const findAll = async (req, res) => {
  ...
  try {
    const grade = await gradesModel.find(condition);
    res.send(grade);
...
const remove = async (req, res) => {
  ...
  try {
    const grade = await gradesModel.findOneAndRemove({ _id: id });
...
const removeAll = async (req, res) => {
  try {
    const grade = await gradesModel.remove({});
